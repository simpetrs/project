                ...
                if (isset($_POST['names'])) {
                    ...
                    if (empty($names) or empty($phone) or empty($address)) {
                        ...
                        mysqli_query($conn, "update user set name = '$names', description = '$description', 
                                              cat = '$job', country = '$country', address = '$address', phone = '$phone', company = '$company' where user_Id = '$user' ") or die(mysqli_query($conn));
                        ?>
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8"><?php echo $rows["company"]; ?></div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Category</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $rows["cat"]; ?></div>
                                    </div>
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php
                                            $cate = mysqli_query($conn, "select * from category  order by cat_name asc");
                                         ?>
